...
export class ResponseFilter {
  ...
  /**
   * Apply all enabled filters to the response
   */
  ...
  /**
   * Apply a single filter based on its action type
   */
  ...
  /**
   * Remove matching patterns from text
   */
  ...
  /**
   * Replace matching patterns with replacement text
   */
  ...
  /**
   * Extract specific content using patterns
   */
